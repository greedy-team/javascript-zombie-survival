...
- 매일 선택지를 고른 후 **식량이 1 소비**되며, **감염도가 3 증가**한다.
...
| 카드             | 장수 | 선택지 A                                  | 선택지 B                                             |
| ---------------- | ---- | ----------------------------------------- | ---------------------------------------------------- |
| 🧟 좀비 무리     | 4    | 맞서 싸운다 (체력 -15)                    | 숨을 죽인다 (체력 -5, 감염도 +3)                     |
...
| 📻 무전 신호     | 3    | 위치를 송신한다 (구조 포인트 +1, 체력 -5) | 덫일 수 있다... 무시 (식량 +1)              |
...
- **치료 선택 5회 누적** → 치료 성공
  - 치료 도움: 🔫 무장한 생존자 - 치료를 부탁한다
  - 자가치료: 😡 감염 발작 - 감염 부위를 도려낸다
